...
fundamental_and_sentimental_analysis = Task(
    description="Perform sentiment analysis from news articles around {end_date}.",
    expected_output="Long and Short Term performance insights of {stock} based on sentiment analysis.",
